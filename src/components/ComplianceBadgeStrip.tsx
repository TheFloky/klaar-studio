...
const icons = [Server, ShieldCheck, Eye, Shield];

export default function ComplianceBadgeStrip({ t }: { t: Translations }) {
  const { ref, isVisible } = useScrollReveal();
  const labels = [t.badges.swissHosted, t.badges.nfadp, t.badges.privacyFirst, t.badges.noUsCloud];
